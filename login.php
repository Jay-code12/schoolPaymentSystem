...
<body >
    <div class="container">
         ...
         <div class="row ">
                ...
                <div class="col-md-6  col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1" style="">
                          
                            <div class="panel-body " style="background-color: #E2E2E2; padding: 20px; margin-top:50px; box-shadow: 10px 10px 5px lightblue;">
							  <h3 class="myhead">School Payment System</h3>
